						...
						<div
							...
							<div class="d-flex justify-content-center py-4">
								<a href="index.html"
									...
									class="d-none d-lg-block">eCom</span>
								</a>
							</div>
							<!-- End Logo -->
							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<div class="pt-4 pb-2">
										<h5 class="card-title text-center pb-0 fs-4">New Product</h5>
										<p class="text-center small">Enter product details</p>
									</div>
									...
									<form class="row g-3 needs-validation" novalidate
										...
										<div class="col-12">
											...
											<input type="text" name="productImagePath" class="form-control"
												 required>
											<div class="invalid-feedback">Please, enter product
												image !</div>
										</div>
